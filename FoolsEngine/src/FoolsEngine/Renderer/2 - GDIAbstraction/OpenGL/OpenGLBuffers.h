...
#include "FoolsEngine\Renderer\2 - GDIAbstraction\Buffers.h"
...
namespace fe
{
	...
	public:
		...
		virtual void SetLayout(const BufferData::Layout& layout) override;
		virtual const BufferData::Layout& GetLayout() const override;

	private:
		uint32_t m_ID;
		uint32_t m_Size;
		BufferData::Layout m_Layout;
