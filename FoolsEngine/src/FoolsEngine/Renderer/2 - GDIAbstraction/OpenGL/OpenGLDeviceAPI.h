...
namespace fe
{
	...
	public:
		...
		virtual void DrawIndexed(const std::shared_ptr<VertexBuffer>& vertexBuffer, uint32_t indexCount = 0) override;
		virtual void DrawIndexed(const std::shared_ptr<VertexBuffer>& vertexBuffer) override;
