...
namespace fe
{
	...
	public:
		...
		virtual void Recreate(const Description::Framebuffer::Specification& spec) = 0;
		...
		virtual const Description::Framebuffer::Specification& GetSpecification() const = 0;

		static Scope<Framebuffer> Create(const Description::Framebuffer::Specification& spec);
	};
}