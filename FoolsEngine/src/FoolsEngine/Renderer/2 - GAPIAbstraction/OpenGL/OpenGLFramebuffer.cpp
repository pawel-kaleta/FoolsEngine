...
namespace fe
{
	OpenGLFramebuffer::OpenGLFramebuffer(const Description::Framebuffer::Specification& spec)
	...
	void OpenGLFramebuffer::Recreate(const Description::Framebuffer::Specification& spec)
	{
		m_Specification = spec;
		Recreate();
	}
	...
	GLenum OpenGLFramebuffer::FormatToGLinternalFormat(Description::Texture::Format format)
	{
		switch (format.Value)
		{
	...
	GLenum OpenGLFramebuffer::FormatToGLtype(Description::Texture::Format format)
	{
		switch (format.Value)
		{
		case Description::Texture::Format::None:
	...
	GLenum OpenGLFramebuffer::FormatToGLformat(Description::Texture::Format format)
	{
		switch (format.Value)
		{
		case Description::Texture::Format::None:
	...
	void OpenGLFramebuffer::Create()
	{
		...
		if (m_Specification.ColorAttachments.size())
		{
			...
			if (m_Specification.DepthStencilFormat != Description::Texture::Format::None)
			{
				GLenum dataFormat = FormatToGLinternalFormat(m_Specification.DepthStencilFormat);
