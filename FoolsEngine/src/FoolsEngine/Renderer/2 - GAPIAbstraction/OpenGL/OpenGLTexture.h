...
namespace fe
{
	...
	{
	public:
		OpenGLTexture2D(const Description::Texture::Specification& specification, uint32_t width, uint32_t height);
		OpenGLTexture2D(const Description::Texture::Specification& spec, const void* data, uint32_t width, uint32_t height);
		~OpenGLTexture2D();
		...
		void SendDataToGPU(void* data, const Description::Texture::Specification& spec, uint32_t width, uint32_t height);
