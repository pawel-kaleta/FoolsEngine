        ...
        struct LoggingLevel {
            enum ValueType {
                ...
                if (string == "Trace") {
                    ...
                    Value = None;
                    fe::Log::GetCoreLogger()->error("CORE ASSERTION FAILED: in file {0} in function {1} at line {2}.", std::filesystem::path("C:\\FE_DEV\\FoolsEngine\\FoolsEngine\\src\\FoolsEngine\\Foundation\\Debug\\Log.h").filename().string(), __builtin_FUNCSIG(), 64);
                    fe::Log::GetCoreLogger()->error("Assertion Message: " "Unrecognised string representation of enum");
                };
            } constexpr const char* ToConstCharPtr() const {
                switch (Value) {
                case Trace: return "Trace"; case Debug: return "Debug"; case Info: return "Info"; case Warn: return "Warn"; case Error: return "Error"; case Fatal: return "Fatal"; case None: return "None";
                default: if (!(false)) {
                    fe::Log::GetCoreLogger()->error("CORE ASSERTION FAILED: in file {0} in function {1} at line {2}.", std::filesystem::path("C:\\FE_DEV\\FoolsEngine\\FoolsEngine\\src\\FoolsEngine\\Foundation\\Debug\\Log.h").filename().string(), __builtin_FUNCSIG(), 71);
                    fe::Log::GetCoreLogger()->error("Assertion Message: " "Unrecognised value of enum");
                }; return "";
                }
