/*
    ...
    OpenGL loader generated by glad 0.1.34 on Thu Jul 15 21:39:30 2021.
...
PFNGLVERTEXARRAYBINDINGAPIVISORPROC glad_glVertexArrayBindinGAPIvisor = NULL;
...
PFNGLVERTEXBINDINGAPIVISORPROC glad_glVertexBindinGAPIvisor = NULL;
...
static void load_GL_VERSION_4_3(GLADloadproc load) {
	...
	glad_glVertexBindinGAPIvisor = (PFNGLVERTEXBINDINGAPIVISORPROC)load("glVertexBindinGAPIvisor");
...
static void load_GL_VERSION_4_5(GLADloadproc load) {
	...
	glad_glVertexArrayBindinGAPIvisor = (PFNGLVERTEXARRAYBINDINGAPIVISORPROC)load("glVertexArrayBindinGAPIvisor");
